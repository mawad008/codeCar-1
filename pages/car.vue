        ...
        <div class="images-text">
          <div class="row">
            <div class="main-col-images col-12 col-xl-6 col-lg-6">
                  ...
                  <div class="iconss d-flex align-items-center gap-3">
                    <div class="icon">
                      <button
                        ...
                        data-bs-target="#vendor-phone-modal"
                        class="icon"
                      >
                        <!-- <img src="@/assets/images/call.svg" alt="" /> -->
                        <i
                          class="fa-solid fa-phone"
                          style="color: #90a3bf; font-size: 14px"
                        ></i>
                      </button>
                    </div>
                    <div>
                      <button
                        data-bs-toggle="modal"
                        data-bs-target="#vendor-whatsapp-modal"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="17"
              ...
              <div
                class="main-images justify-content-start justify-content-xl-between justify-content-lg-between"
              >
                <swiper
                  :style="{
                ...
                >
                  <swiper-slide v-if="mainCar.video_url">
                    <iframe
                      v-if="mainCar.video_url"
                      :src="`https://www.youtube.com/embed/${mainCar.video_url}`"
      ...
      gyroscope; picture-in-picture"
                ...
                <div class="d-flex align-items-center gap-3 mt-3">
                  ...
                  >
                    <swiper-slide
                      v-if="mainCar.video_url"
                      :class="{ 'auto-width': mainCar.images.length <= 4 }"
                    >
            ...
            <div class="col-12 col-xl-6 col-lg-6">
              <div>
                ...
                <div class="description">
                  ...
                  <div
                    class="descDiv"
                    v-html="mainCar.description"
                    :class="{ active: mainCar.description.length >= 235 }"
                  ></div>
                </div>
                ...
                <div class="price">
                  ...
                  <div class="main-price">
                    ...
                    <span v-if="mainCar.have_discount == 1" class="disc"
                      >{{ mainCar.price }} {{ $t("curr") }}</span
                    >
                    <span
                      >( {{ mainCar.price_after_tax }} {{ $t("curr") }}
                      {{ $t("taxx") }} )</span
                    >
                  </div>
                </div>
                ...
                <div class="btns">
                  ...
                  <a
                    ...
                    href="#finance-payment-container"
                    @click="paymentType = 2"
                    class="finance"
                    >{{ $t("finance") }}</a
                  >
        ...
        <div class="row">
          ...
          <div class="col-6 col-xl-2 col-lg-2 col-lg-4">
            <div class="box">
              ...
              <span class="type"
                >{{ mainCar.kilometer ? mainCar.kilometer : 0 }}
                {{ $t("km") }}</span
              >
            </div>
          </div>
                ...
                <div class="d-flex flex-column flex-xl-row flex-lg-row gap-3">
                  <div class="input-container">
                    ...
                    <div class="input">
                      ...
                      <span
                        class="error-msg"
                        v-if="v2$.organization_name.$error"
                        >{{ v2$.organization_name.$errors[0].$message }}</span
                      >
                    </div>
                  ...
                  <div class="input-container">
                    ...
                    <div class="input">
                      ...
                      <span
                        class="error-msg"
                        v-if="v2$.organization_type.$error"
                        >{{ v2$.organization_type.$errors[0].$message }}</span
                      >
                      <span
                        class="error-msg"
                        v-if="errors2.organization_type"
                        >{{ errors2.organization_type[0] }}</span
                      >
                    </div>
                  </div>
                </div>
                <div class="d-flex flex-column flex-xl-row flex-lg-row gap-3">
                  <div class="input-container">
                    ...
                    <div class="input">
                      ...
                      <span
                        class="error-msg"
                        v-if="v2$.commercial_registration_no.$error"
                        >{{
                    ...
                    <span
                      ...
                      v-if="errors2.commercial_registration_no"
                  ...
                  <div class="input-container">
                    ...
                    <div class="input">
                      ...
                      <span
                        class="error-msg"
                        v-if="v2$.organization_activity.$error"
                        >{{
                      ...
                      <span
                        class="error-msg"
                        v-if="errors2.organization_activity"
                        >{{ errors2.organization_activity[0] }}</span
                      >
                    </div>
                  </div>
                </div>
                ...
                <div class="d-flex flex-column flex-xl-row flex-lg-row gap-3">
                  <div class="input-container">
                    ...
                    <div class="input">
                      ...
                      <span
                        class="error-msg"
                        v-if="v2$.organization_age.$error"
                        >{{ v2$.organization_age.$errors[0].$message }}</span
                      >
                    </div>
                    <span
                      class="error-msg mt-1"
                      v-if="errors2.organization_age"
                      >{{ errors2.organization_age[0] }}</span
                    >
                  </div>
      ...
      >
        <div class="modal-dialog">
          <div class="modal-content log-out-modal car">
            <img
              v-if="mainCar.vendor.type == 'individual'"
              src="~/assets/images/whats-model.svg"
            />
            ...
            <div class="btns1">
              <div v-if="mainCar.vendor.type == 'individual'">
                ...
                <div v-if="btnModel2 == 2" class="copy">
                  <a
                    :href="mainCar.vendor.whatsapp_link"
                    target="_blank"
                    class="icon"
                  >
                    <svg
      ...
      >
        <div class="modal-dialog">
          <div class="modal-content log-out-modal car">
            <img
              v-if="mainCar.vendor.type == 'individual'"
              src="~/assets/images/phone-model.svg"
            />
...
const addFavFunc = async () => {
  ...
  let result = await axios.post(
    `${getUrl()}/${
      tokenCookie ? "add-favorite-withauth" : "add-favorite-withoutauth"
    }`,
    { car_id: id.value },
    {
      headers: {
