    ...
    <div v-if="mainCar" class="main-car-page container">
      <div class="car-details">
                  ...
                  <div>
                    <div class="vendor-icon">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <span class="city" v-if="mainCar.vendor.city">
                          {{ mainCar.vendor.city.name }}
                        </span>
                      </div>
                    </div>
                  ...
                  <div class="icons">
                    <div class="icon" @click="shareIcons = !shareIcons">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M19.2233 5.28C19.2233 3.95452 18.1488 2.88 16.8233 2.88C15.4978 2.88 14.4233 3.95452 14.4233 5.28C14.4233 6.60549 15.4978 7.68 16.8233 7.68C18.1488 7.68 19.2233 6.60549 19.2233 5.28ZM19.2233 17.76C19.2233 16.4345 18.1488 15.36 16.8233 15.36C15.4978 15.36 14.4233 16.4345 14.4233 17.76C14.4233 19.0855 15.4978 20.16 16.8233 20.16C18.1488 20.16 19.2233 19.0855 19.2233 17.76ZM6.26328 9.60001C7.58876 9.60001 8.66328 10.6745 8.66328 12C8.66328 13.3255 7.58876 14.4 6.26328 14.4C4.9378 14.4 3.86328 13.3255 3.86328 12C3.86328 10.6745 4.9378 9.60001 6.26328 9.60001ZM13.6341 6.34055C13.7366 6.64885 13.8825 6.93731 14.0646 7.19868L8.7806 9.77448C8.54693 9.51038 8.27234 9.28331 7.96676 9.10322L13.6341 6.34055ZM13.6647 16.6115C13.5531 16.9184 13.4849 17.2462 13.4676 17.5874L8.04526 14.8491C8.34052 14.664 8.60496 14.4343 8.82912 14.1695L13.6647 16.6115Z"
                          fill="#90A3BF" />
                      </svg>
                    ...
                    <div @click="addFavFunc()" class="icon">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          ...
                          :fill="`${mainCar.is_fav ? '#ED3F3F' : '#90A3BF'}`" />
                      </svg>
                    </div>
                  </div>
                </div>
        ...
        gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="d-flex align-items-center gap-3 mt-3">
                  ...
                  <swiper @swiper="setThumbsSwiper" :loop="true" :spaceBetween="10" :freeMode="true"
            ...
            <div class="col-12 col-xl-6 col-lg-6">
              <div>
                ...
                <div class="description">
                  ...
                  <div class="descDiv" v-html="mainCar.description"
                    :class="{ active: mainCar.description.length >= 235 }"></div>
                </div>

                <div class="price">
                  <span class="word fw-bold">{{ $t("price") }}</span>
                  <div v-if="mainCar?.statuekey == 0 && mainCar.price == 0"
                    class="d-flex align-items-cente justify-content-cente mt-4">
                    <span class="fw-bolder text-gray"> {{ $t('Asoum') }} </span>
                  </div>
                  <div v-else class="main-price">
                    <h5 class="price-dir">{{ mainCar.selling_price }} <riyal width="15" class="mb-1 mx-1" color="#90a3bf"></riyal></h5>
                    <span v-if="mainCar.have_discount == 1" class="disc price-dir">{{ mainCar.price }} <riyal width="15" class="mb-1 mx-1" color="#90a3bf"></riyal></span>
                    <span class="price-dir">( {{ mainCar.price_after_tax }} <riyal width="15" class="mb-1 mx-1" color="#90a3bf"></riyal>
                      {{ $t("taxx") }} )</span>
                  </div>
                </div>
                <div class="colors">
                  ...
                  <div class="main" v-if="mainCar.color">
                    <div v-for="i in mainCar.color" class="d-flex flex-column align-items-center gap-2">
                      <div class="color-hexa" :class="{ 'light-color': isLightColor(i.hex_code) }"
                        :style="{ backgroundColor: i.hex_code }"></div>
                      <span> {{ i.name }} </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="btns">
                  <a href="#cash-payment-container" @click="paymentType = 1" class="cash"
                    :class="{ active: mainCar.statuekey == 0 }">{{ $t("purchaseOrder") }}</a>
                  <a v-if="mainCar.statuekey == 1" href="#finance-payment-container" @click="paymentType = 2"
                    class="finance">{{ $t("finance") }}</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-6 col-xl-2 col-lg-2 col-lg-4">
            <div class="box">
              ...
              <span class="type">{{ mainCar.kilometer ? mainCar.kilometer : 0 }}
                {{ $t("km") }}</span>
            </div>
          </div>
          <div class="col-6 col-xl-2 col-lg-2 col-lg-4">
      ...
      <div :class="{
        ...
        <div id="cash-payment-container" v-if="paymentType == 1" class="payment-container">
          ...
          <div class="payment-method">
            <button @click="btnCash = 1" :class="{ active: btnCash == 1 }" class="one">
              {{ $t("ind") }}
            </button>
            <button @click="btnCash = 2" :class="{ active: btnCash == 2 }" class="two">
              {{ $t("comp") }}
            </button>
          </div>
                ...
                <div class="row ">
                  <div class="col-12 col-xl-6 col-lg-6 ">
                    <div class="input-container custom ">
                      ...
                      <div class="input">
                        <!-- optionLabel="title" -->
                        <Dropdown v-model="formCash1.color_id"
                          :options="mainCar.color ? mainCar.color : optionsCars.colors" filter optionValue="id"
                          :optionLabel="`${mainCar.color ? 'name' : 'title'}`" :filter-placeholder="$t('search')"
                          :placeholder="$t('color')" class="">
                  ...
                  <div class="col-12 col-xl-6 col-lg-6">
                    <div class="input-container custom">
                      <span> {{ $t("kind") }} </span>
                      <div class="input">
                        <Dropdown v-model="formCash1.type_of_order" :options="typeOfOrders" filter optionValue="value"
                          optionLabel="name" :filter-placeholder="$t('search')" class="">
                          <template #option="slotProps">
                            <div class="flex align-items-center">
              ...
              <div class="form-ind">
                <div class="d-flex flex-column flex-xl-row flex-lg-row gap-3">
                  ...
                  <div class="input-container">
                    <span> {{ $t("orgType") }}</span>
                    <div class="input">
                      <Dropdown v-model="formCash2.organization_type" :options="optionsCars.OrganizationType" filter
                        optionValue="id" :filter-placeholder="$t('search')" optionLabel="title"
                        :placeholder="$t('orgType')" class="">
                        <template #option="slotProps">
                          <div class="flex align-items-center">
                      ...
                      <span class="error-msg" v-if="errors2.organization_type">{{ errors2.organization_type[0] }}</span>
                    </div>
                  </div>
                </div>
                <div class="d-flex flex-column flex-xl-row flex-lg-row gap-3">
                  <div class="input-container">
                    ...
                    <span class="error-msg mt-1" v-if="errors2.commercial_registration_no">{{
                      errors2.commercial_registration_no[0] }}</span>
                  </div>

                  <div class="input-container">
                    <span> {{ $t("orgAct") }}</span>
                    <div class="input">
                      <Dropdown v-model="formCash2.organization_activity" :options="optionsCars.OrganizationActive"
                        filter optionLabel="title" :filter-placeholder="$t('search')" optionValue="id"
                        :placeholder="$t('orgAct')" class="">
                        <template #option="slotProps">
                          <div class="flex align-items-center">
                            <div>{{ slotProps.option.title }}</div>
                          </div>
                      ...
                      <span class="error-msg" v-if="errors2.organization_activity">{{ errors2.organization_activity[0]
                        }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="d-flex flex-column flex-xl-row flex-lg-row gap-3">
                  <div class="input-container">
                    ...
                    <span class="error-msg mt-1" v-if="errors2.organization_age">{{ errors2.organization_age[0]
                      }}</span>
                  </div>
                  ...
                  <div class="input-container">
                    <span> {{ $t("city") }} </span>
                    <div class="input">
                      <Dropdown v-model="formCash2.city_id" :options="cities" filter :filter-placeholder="$t('search')"
                        optionLabel="name" optionValue="id" :placeholder="$t('city')" class="">
                        <template #option="slotProps">
                          <div class="flex align-items-center">
                            <div>{{ slotProps.option.name }}</div>
                          </div>
                ...
                <div class="d-flex flex-column flex-xl-row flex-lg-row gap-3">
                  <div class="input-container">
                    <span> {{ $t("bankk") }}</span>
                    <div class="input">
                      <Dropdown v-model="formCash2.bank_id" :options="optionsCars.banks" filter
                        :filter-placeholder="$t('search')" optionLabel="name" optionValue="id"
                ...
                <div class="d-flex flex-column flex-xl-row flex-lg-row gap-3">
                  <div class="input-container">
                    <span> {{ $t("color") }}</span>
                    <div class="input">
                      <Dropdown v-model="formCash2.color_id"
                        :options="mainCar.color ? mainCar.color : optionsCars.colors" filter optionValue="id"
                        :optionLabel="`${mainCar.color ? 'name' : 'title'}`" :filter-placeholder="$t('search')"
                        :placeholder="$t('color')" class="">
                        <template #option="slotProps">
                  ...
                  <div class="input-container">
                    <span> {{ $t("kind") }}</span>
                    <div class="input">
                      <Dropdown v-model="formCash2.type_of_order" :options="typeOfOrders" optionValue="value"
                        optionLabel="name" :filter-placeholder="$t('search')" class="">
                        <template #option="slotProps">
                          <div class="flex align-items-center">
                            <div>{{ slotProps.option.name }}</div>
            ...
            <div class="col-12 col-xl-4 col-lg-4" style="position: relative">
              <div class="info-data">
                ...
                <div class="icons">
                  ...
                  <div class="icon map d-block d-xl-flex d-lg-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path
                        d="M12 1.5C9.81276 1.50258 7.71584 2.3726 6.16923 3.91922C4.62261 5.46584 3.75259 7.56276 3.75001 9.75C3.74739 11.5374 4.33124 13.2763 5.41201 14.7C5.41201 14.7 5.63701 14.9963 5.67376 15.039L12 22.5L18.3293 15.0353C18.3623 14.9955 18.588 14.7 18.588 14.7L18.5888 14.6978C19.669 13.2747 20.2526 11.5366 20.25 9.75C20.2474 7.56276 19.3774 5.46584 17.8308 3.91922C16.2842 2.3726 14.1873 1.50258 12 1.5ZM12 12.75C11.4067 12.75 10.8266 12.5741 10.3333 12.2444C9.83995 11.9148 9.45543 11.4462 9.22837 10.8981C9.00131 10.3499 8.9419 9.74667 9.05765 9.16473C9.17341 8.58279 9.45913 8.04824 9.87869 7.62868C10.2982 7.20912 10.8328 6.9234 11.4147 6.80764C11.9967 6.69189 12.5999 6.7513 13.1481 6.97836C13.6962 7.20542 14.1648 7.58994 14.4944 8.08329C14.8241 8.57664 15 9.15666 15 9.75C14.999 10.5453 14.6826 11.3078 14.1202 11.8702C13.5578 12.4326 12.7954 12.749 12 12.75Z"
                        fill="#90A3BF" />
        ...
        <div id="finance-payment-container" v-if="paymentType == 2 && mainCar.statuekey == 1"
          ...
          <div v-if="paymentMethod == 1">
            <financecar1 :carid="id" :colors="mainCar.color" :price2="optionsCars.car_profit"
              :price="mainCar.price_after_tax" />
          </div>
          <div v-if="paymentMethod == 2">
            <financecar2 :carid="id" :price="mainCar.price_after_tax" :car="mainCar" :colors="mainCar.color" />
          </div>
        </div>
      </div>
      ...
      <div v-if="showConfirmCash" class="confirm-container">
        <div v-if="otpCash == 1" class="confirm-text">
          ...
          <span class="error-msg2" v-if="error1">{{ error1 }}</span>
          <button class="resend" @click="resendOtp1()">
            {{ $t("reOtp") }}
          </button>
        ...
        <div v-if="otpCash == 2" class="confirm-text">
          ...
          <div class="order-number">
            <h5>
              {{ $t("orderNum") }} : <span>{{ orderNum1 }}</span>
            </h5>
      ...
      <div v-if="store.state.showConfirm1" class="confirm-container">
        <div v-if="paymentOtp == 1" class="confirm-text">
          ...
          <span class="error-msg2" v-if="error2">{{ error1 }}</span>
          <button class="resend" @click="resendOtp2()">
            {{ $t("reOtp") }}
          </button>
        ...
        <div v-if="paymentOtp == 2" class="confirm-text">
          ...
          <div class="order-number">
            <h5>
              {{ $t("orderNum") }} : <span>{{ orderNum2 }}</span>
            </h5>
      ...
      <div class="modal fade" id="vendor-whatsapp-modal" tabindex="-1" aria-labelledby="logout-modal"
        aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content log-out-modal car">
            ...
            <h4 v-if="mainCar.vendor.type == 'individual'">
              {{ $t("loginModel1") }}
            </h4>
            <h4 v-else>{{ $t("loginModel2") }}</h4>
            <p v-if="mainCar.vendor.type == 'individual'">
              {{ $t("loginModel4") }}
            </p>
            ...
            <div class="btns1">
              ...
              <button class="stroke" data-bs-dismiss="modal" aria-label="Close">
                {{ $t("back") }}
              </button>
            </div>
          </div>
      ...
      <div class="modal fade" id="vendor-phone-modal" tabindex="-1" aria-labelledby="logout-modal" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content log-out-modal car">
            ...
            <div class="btns1">
              <div v-if="mainCar.vendor.type == 'individual'">
                <button class="fill" v-if="btnModel == 1" @click="btnModel = 2">
                  {{ $t("getnum") }}
                </button>
                <div v-if="btnModel == 2" class="copy">
                  <svg v-if="copyPhone" @click="copyToClipboard()" xmlns="http://www.w3.org/2000/svg" width="24"
...
const cashFunc1 = async () => {
  if (btnCash.value == 1) {
    ...
    formBody.append(
      "commercial_registration_no",
      formCash2.value.commercial_registration_no
    );
    formBody.append(
      "organization_activity",
      formCash2.value.organization_activity
    );
...
const resendOtp1 = async () => {
  ...
  formBody.append(
    "phone",
    btnCash.value == 1 ? formCash1.value.phone : formCash2.value.phone
  );
  formBody.append("orderId", orderNumber1.value);
  try {
