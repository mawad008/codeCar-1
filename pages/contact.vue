                ...
                <div class="row justify-content-between">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-6 my-3">
                                    <div class="icon-container">
                                        ...
                                        <span>العنوان</span>
                                        <h6>المملكة العربية السعودية - الرياض - معارض القادسية - شارع وادي اللجام</h6>
                                    </div>
                                </div>
                                <div class="col-6 my-3">
                                    <div class="icon-container">
                    ...
                    <div class="col-5">
                        <div class="form-container">
                         <div class="input">
                          <label> الاسم </label>
                          <input type="text" placeholder="مثال : رضا">
                         </div>
                         <div class="input">
                          <label> رقم الهاتف </label>
                          <input type="text" placeholder="مثال : 3333-5555-9999-55">
                         </div>
                         <div class="input">
                          <label> البريد الالكتروني </label>
                          <input type="email" placeholder="مثال : Demo@icloud.com">
                         </div>
                         <div class="input">
                          <label> رسالتك </label>
                          <textarea style="resize:none;" placeholder="اكتب رسالتك هنا" id="" cols="30" rows="10"></textarea>
                         </div>
