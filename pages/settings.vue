    ...
    <tbody>
        <tr v-for="(item, index) in carsAds" :key="index" class="content">
          <td class="img-container flex-colum">
                    ...
                    <td class="price price-dir">{{ item.price }} <riyal class="mb-1 mx-1" color="#90a3bf"></riyal></td>
            ...
            <div v-if="settingNav == 5" id="safe-mobile" class="personal">
              <div class="personal-form">
                <div class="input pass">
                  ...
                  <input :type="passType" placeholder="***************" name=""
                v-model="form1.old_password" />
              <div @click="changePass1()" class="icon">
                <svg v-if="passType == 'password'" xmlns="http://www.w3.org/2000/svg" width="24" height="16"
                ...
                <svg v-if="passType == 'text'" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="d-flex w-100 flex-column flex-xl-row flex-lg-row phoneContainer align-items-start align-items-xl-center align-items-lg-center justify-content-between">
                  ...
                  <input :type="passType1" placeholder="***************" name=""
                v-model="form1.password" />
              <div @click="changePass2()" class="icon">
                <svg v-if="passType1 == 'password'" xmlns="http://www.w3.org/2000/svg" width="24" height="16"
                  viewBox="0 0 24 16" fill="none">
                  <path
                    d="M23.9204 7.6296C23.2116 6.0552 19.9696 0 12 0C4.0304 0 0.7884 6.0552 0.0796 7.6296C0.0264 7.748 0 7.8744 0 8C0 8.1256 0.0264 8.252 0.0796 8.3704C0.7884 9.9444 4.0304 16 12 16C19.9696 16 23.2116 9.9444 23.9204 8.3704C23.9736 8.252 24 8.1256 24 8C24 7.8744 23.9736 7.748 23.9204 7.6296ZM12 13.2C9.128 13.2 6.8 10.872 6.8 8C6.8 5.128 9.128 2.8 12 2.8C14.872 2.8 17.2 5.128 17.2 8C17.2 10.872 14.872 13.2 12 13.2Z"
                    fill="#90A3BF" />
                ...
                <svg v-if="passType1 == 'text'" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                  viewBox="0 0 24 24" fill="none">
                  <path
                    d="M21.2699 9.17981C20.9799 8.71981 20.6699 8.28981 20.3499 7.88981C19.9799 7.41981 19.2799 7.37981 18.8599 7.79981L15.8599 10.7998C16.0799 11.4598 16.1199 12.2198 15.9199 13.0098C15.5699 14.4198 14.4299 15.5598 13.0199 15.9098C12.2299 16.1098 11.4699 16.0698 10.8099 15.8498C10.8099 15.8498 9.37995 17.2798 8.34995 18.3098C7.84995 18.8098 8.00995 19.6898 8.67995 19.9498C9.74995 20.3598 10.8599 20.5698 11.9999 20.5698C13.7799 20.5698 15.5099 20.0498 17.0899 19.0798C18.6999 18.0798 20.1499 16.6098 21.3199 14.7398C22.2699 13.2298 22.2199 10.6898 21.2699 9.17981Z"
                    fill="#90A3BF" />
                ...
                <div class="d-flex w-100 flex-column flex-xl-row flex-lg-row phoneContainer align-items-start align-items-xl-center align-items-lg-center justify-content-between">
                  ...
                  <input :type="passType2" placeholder="***************" name=""
                v-model="form1.password_confirmation" />
              <div @click="changePass3()" class="icon">
                <svg v-if="passType2 == 'password'" xmlns="http://www.w3.org/2000/svg" width="24" height="16"
                  viewBox="0 0 24 16" fill="none">
                  <path
                    d="M23.9204 7.6296C23.2116 6.0552 19.9696 0 12 0C4.0304 0 0.7884 6.0552 0.0796 7.6296C0.0264 7.748 0 7.8744 0 8C0 8.1256 0.0264 8.252 0.0796 8.3704C0.7884 9.9444 4.0304 16 12 16C19.9696 16 23.2116 9.9444 23.9204 8.3704C23.9736 8.252 24 8.1256 24 8C24 7.8744 23.9736 7.748 23.9204 7.6296ZM12 13.2C9.128 13.2 6.8 10.872 6.8 8C6.8 5.128 9.128 2.8 12 2.8C14.872 2.8 17.2 5.128 17.2 8C17.2 10.872 14.872 13.2 12 13.2Z"
                    fill="#90A3BF" />
                ...
                <svg v-if="passType2 == 'text'" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                  viewBox="0 0 24 24" fill="none">
                  <path
                    d="M21.2699 9.17981C20.9799 8.71981 20.6699 8.28981 20.3499 7.88981C19.9799 7.41981 19.2799 7.37981 18.8599 7.79981L15.8599 10.7998C16.0799 11.4598 16.1199 12.2198 15.9199 13.0098C15.5699 14.4198 14.4299 15.5598 13.0199 15.9098C12.2299 16.1098 11.4699 16.0698 10.8099 15.8498C10.8099 15.8498 9.37995 17.2798 8.34995 18.3098C7.84995 18.8098 8.00995 19.6898 8.67995 19.9498C9.74995 20.3598 10.8599 20.5698 11.9999 20.5698C13.7799 20.5698 15.5099 20.0498 17.0899 19.0798C18.6999 18.0798 20.1499 16.6098 21.3199 14.7398C22.2699 13.2298 22.2199 10.6898 21.2699 9.17981Z"
                    fill="#90A3BF" />
