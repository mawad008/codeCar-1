                ...
                <div class="col-12 col-xl-3 col-lg-3" style="position: relative">
                    <div class="setting-nav">
                      ...
                      29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
                        ...
                        <div @click="settingNav = 2" class="item justify-content-between"
                      ...
                      29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
                        ...
                        <div @click="settingNav = 3" class="item" :class="{ 'active': settingNav == 3 }">
                            <div class="icon">
                    ...
                    <div class="setting-content">
                        ...
                        <div class="">
                            ...
                            <div class="filter-table">
                                ...
                                <div v-for="i in 6" class="content">
                                    ...
                                    <v-switch color="#38A2A4"></v-switch>
                                    <button>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none">
                                            <path
                              ...
                              <div class="empty d-none">
                                 <div class="main">
                                  ...
                                  <span>  يمكنك بسهولة إضافة سيارتك للبيع وإدارة إعلاناتك من هنا. ابدأ الآن في نشر إعلانك وجذب المزيد من الاهتمام! </span>
                        ...
                        <div v-if="settingNav == 3" class="fav-cars">
                            <div class="row">
                                <div v-for="i in 6" class="col-12 col-xl-4 col-lg-4 col-md-6 my-3">
                                    <CarCard style="border: 1px solid #EBEAED; border-radius: 16px;" />
                                </div>
                            </div>
                            ...
                            <div class="empty d-none">
                             <div class="main">
                              ...
                              <span>أضف مفضلتك الأولى الآن، سنكون هنا لمساعدتك في العثور على السيارة المثالية لتكمل رحلتك على الطريق </span>
                        ...
                        <div  v-if="settingNav == 4" class="notifications">
                            <div class="item active">
                                ...
                                <div class="text d-flex w-100 flex-column">
                                    ...
                                    <span>نحن نقوم بمعالجة طلبك بسرعة. انتظر قدومه قريبًا واستعد لتجربة رائعة. شكرًا لصبرك واختيارك لنا.</span>
                                </div>
                            </div>
                            <div class="item active">
                                <div class="icon">
                ...
                <div class="modal-dialog">
                    <div class="modal-content log-out-modal">
                        ...
                        <div class="btns">
                            ...
                            <button class="back" data-bs-dismiss="modal" aria-label="Close"> العودة </button>
                        </div>
                    </div>
