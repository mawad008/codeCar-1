        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <div
            ...
            <div v-if="overlay" class="searchBar">
              <input type="text" @keypress.enter="goCarsFilterByName()" v-model="searchValue"
            ...
            <nuxt-link :to="localePath('/wishlist')" class="nav-link icon">
              ...
              <svg class="dark-img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="white">
                <path fill-rule="evenodd" clip-rule="evenodd"
              ...
              <svg class="white-img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="#90A3BF">
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M12.3812 6.13389C14.1606 4.35511 17.0457 4.35511 18.8252 6.13389C20.6047 7.91277 20.6047 10.797 18.8252 12.5759L12.3392 19.0593C12.1518 19.2466 11.8479 19.2466 11.6605 19.0593L5.17453 12.5759C3.39495 10.797 3.39495 7.91277 5.17453 6.13389C6.95401 4.35511 9.83904 4.35511 11.6185 6.13389L11.9998 6.51506L12.3812 6.13389Z"
                  fill="" />
...
<path
    ...
    <div v-if="footerData">
      <a v-if="footerData.whatsapp" aria-label="whats-app" target="_blank" :href="footerData.whatsapp" class="whats-app-icon"
        ...
        <div class="container">
          ...
          <div class="row justify-content-between">
            <div class="col-12 col-xl-4 col-lg-4 col-md-6">
              <div v-if="footerData" class="box-container d-flex flex-column justify-content-center gap-3">
                <div
                  class="d-flex justify-content-center justify-content-xl-start justify-content-lg-start justify-content-lg-start">
                  <!-- <img class="img-flui" :src="footerData.logo" style="width: 74px; height: 46px; object-fit: cover"
                    alt="" /> -->
              <NuxtImg :src="footerData.logo" format="webp" :alt="footerData.description" quality="80" width="74" height="46" fit="cover"  loading="lazy" />
                ...
                <div v-if="footerData"
                  ...
                  <div v-if="footerData.youtube" class="col-12 col-xl-2 col-lg-2 col-md-4 icon">
                    <a target="_blank" aria-label="youtube" :href="footerData.youtube">
                  ...
                  <div v-if="footerData.instagram" class="col-12 col-xl-2 col-lg-2 col-md-4 icon">
                    <a target="_blank" aria-label="instagram" :href="footerData.instagram">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <div v-if="footerData.facebook" class="col-12 col-xl-2 col-lg-2 col-md-4 icon">
                    <a target="_blank" aria-label="facebook" :href="footerData.facebook">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <div v-if="footerData.snapchat" class="col-12 col-xl-2 col-lg-2 col-md-4 icon">
                    <a target="_blank" aria-label="snapchat" :href="footerData.snapchat">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path
                  ...
                  <div v-if="footerData.twitter" class="col-12 col-xl-2 col-lg-2 col-md-4 icon">
                    <a target="_blank" aria-label="twitter" :href="footerData.twitter">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path
                  ...
                  <div v-if="footerData.tiktok" class="col-12 col-xl-2 col-lg-2 col-md-4 icon">
                    <a target="_blank" aria-label="tiktok" :href="footerData.tiktok">
                      <svg xmlns="http://www.w3.org/2000/svg"  width="20" height="21" viewBox="0 0 20 21" fill="none">
                        ...
                        <defs>
                          <clipPath id="clip0_294_522">
                            <rect width="20" height="20" fill="white" transform="translate(0 0.500488)" />
                          </clipPath>
                        </defs>
                      </svg>
                    </a>
