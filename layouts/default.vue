<template>
  <div>
    <nav class="navbar" :class="{ active: activeNav }">
      <div class="container">
        <div
          class="items w-100 d-flex align-items-center justify-content-between"
        >
          <div class="logo">
          ...
          <div class="search">
            ...
            <div class="search-input">
              <div class="input">
                ...
                <input type="text" placeholder="أدخل البريد الالكترونى" />
              </div>
              <button>الانضمام</button>
            </div>
          </div>
          ...
          <div class="row justify-content-between">
            <div class="col-12 col-xl-4 col-lg-4 col-md-6">
              ...
              >
                ...
                />
                <p class="">
                  منصة موقع كود كار تختص في بيع وشراء وتمويل السيارات بطرق حديثة
                  ومتطورة لتصل الى كل من يرغب أن يعلن او يبحث عن سيارة أحلامه
                  نقداً او عن طريق التمويل التأجيري مع أفضل جهات التمويل
            ...
            <div
              class="col-12 col-xl-2 col-lg-2 d-flex justify-content-end col-md-6"
            >
              <div
