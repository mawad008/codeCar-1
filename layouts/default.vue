      ...
      $t("offers") }}</nuxt-link>
          ...
          <div
            ...
            <div @click="overlay = !overlay" class="icon d-none d-xl-flex d-lg-flex  ">
              ...
              <svg class="white-img" xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                fill="none">
...
<path
    ...
    <div v-if="footerData">
      <a v-if="footerData.whatsapp" target="_blank" :href="footerData.whatsapp" class="whats-app-icon"
