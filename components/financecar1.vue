          ...
          <div class="d-flex gap-3">
            <div class="input-container">
              ...
              <div class="input">
                ...
                <input v-model="carDet.brand" readonly />
            ...
            <div class="input-container">
              ...
              <div class="input">
                ...
                <input v-model="carDet.model" readonly />
          ...
          <div class="d-flex gap-3">
            <div class="input-container">
              ...
              <div class="input">
                ...
                <input v-model="carDet.year" readonly />
            ...
            <div class="input-container">
              ...
              <div class="input">
                ...
                <input v-model="carDet.gear_shifter" readonly />
        ...
        <div v-if="paymentIndividualBtn == 5" class="final-review">
          ...
          <div>
            ...
            <div class="btns">
              ...
              <button @click="paymentFunc5()" class="next gap-3">
