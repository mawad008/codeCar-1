         ...
         <div class="login">
               ...
               <div v-if="loginNav == 1">
                <div class="">
                  ...
                  <div class="text">
                    <h3>مرحباً مجدداً! قم بتسجيل الدخول</h3>
                    <span>  أدخل بياناتك للوصول إلى حسابك الشخصي </span
                    >
                  </div>
                  ...
                  <div class="mainform">
                    ...
                    <div class="d-flex align-item-center justify-content-center">
                      <div class="d-flex align-items-center gap-2 linkk">
                        ...
                        <span @click="store.state.checkForm = 1" class="active"> انشاء حساب</span>
                      </div>
                    </div>
                   ...
                   <div class="">
                      ...
                      >
                       ...
                       <div class="text">
                        ...
                        <span>  قم بإدخال رقم هاتفك لتلقي كود التفعيل لاعادة تعيين كلمة المرور والعودة إلى تجربة كود كار بأمان.      </span
                        >
                      </div>
                     <div class="mainform">
                    <div class="form">
                       ...
                       <div class="">
                          ...
                          >
                           ...
                           <div class="text">
                            ...
                            <span>  قم باعادة تعيين كلمة المرور من خلال انشاء كلمة المرور جديدة ثم قم بتأكيدها      </span
                            >
                          </div>
                         <div class="mainform">
                        <div class="form">
