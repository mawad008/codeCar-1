        ...
        <div class="mainform">
          <div class="form">
            ...
            <div class="input pass">
              ...
              <input :type="passType" placeholder="***************" name="" @keypress.enter="loginFunc()"
          ...
          <div class="icons-container">
            ...
            <div class="d-flex align-item-center justify-content-center">
              <a target="_blank" href="https://webstdy.com/ar?utm_source=codeCar-foorter&utm_medium=referral"
                class="d-flex align-items-center gap-3 logo">
                <span> {{ $t('powred') }} </span>
        ...
        <div class="mainform">
          <div class="form">
            ...
            <div class="input pass">
              ...
              <input :type="passType1" placeholder="***************" name="" v-model="pass" />
            ...
            <div class="input pass">
              ...
              <input :type="passType2" placeholder="***************" name="" v-model="newPass" />
