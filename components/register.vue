               ...
               <div v-if="signNav == 1">
                <div class="">
                  ...
                  <div class="text">
                    ...
                    <span
                      >أدخل بياناتك وانشئ حسابك الآن للاستفادة من كل ميزاتنا.</span
                    >
                  </div>
                  ...
                  >
                    <div class="d-flex align-items-center radio">
                      <v-radio
                        ...
                        :value="1"
                      ></v-radio>
                      <label for="radio-input-1" :class="{ active: type == 1 }">
                        فرد
                      </label>
                    </div>
                    <div class="d-flex align-items-center radio">
                      <v-radio
                        ...
                        :value="2"
                      ></v-radio>
                      <label for="radio-input-2" :class="{ active: type == 2 }">
                        معرض
                      </label>
                    </div>
                    <div class="d-flex align-items-center radio">
                      <v-radio
                        ...
                        :value="3"
                      ></v-radio>
                      <label for="radio-input-3" :class="{ active: type == 3 }">
                        وكالة
                      </label>
                    </div>
                  </v-radio-group>
                  <div class="mainform">
                    ...
                    <div class="d-flex align-item-center justify-content-center">
                      <div class="d-flex align-items-center gap-2 linkk">
                        ...
                        <span @click="store.state.checkForm = 2" class="active">تسجيل دخول</span>
                      </div>
                    </div>
                    <div class="icons">
                      <div class="icon">
